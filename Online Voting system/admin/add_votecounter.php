...
<body>
    ...
    <form method="post" enctype="multipart/form-data">
        <div style="padding:1px 16px; position:relative; z-index:1;">
            <h2 align="center">ADD VOTE COUNTER</h2>
            <table align="center">
                <tr>
            ...
            if (isset($_POST["submit"]) && isset($_POST["area"])) {
                ...
                if ($row[2] == 0) {
                    ...
                    $photo = $_POST["id"] . ".jpg";
                    $area = $_POST["area"];
                    $qury = mysqli_query($system, "INSERT into vote_counter (`name`,`login_id`,`password`,`photo`,`area`)
                    ...
                    echo "<script>
							alert('Voting Started You Cannot ADD Vote Counter');
						</script>";
                }
            }
            ?>
