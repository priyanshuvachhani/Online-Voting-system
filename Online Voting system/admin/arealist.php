...
<body>
	<form method="post">
		...
		<div style="margin-left:15%; padding:1px 16px;">
			<h2 align="center">LIST OF AREA</h2>
			<?php
			$qury = mysqli_query($system, "SELECT * from area");
			...
			while ($row = mysqli_fetch_array($qury)) {
				...
				echo "
					<tr align='center'>
						<td>" . $no . "</td>
						<td>" . $row[1] . "</td>
						<td class='edit'><a href='editarea.php?no=" . $row[0] . "'>Edit</a></td>
						<td class='delet'><a href='deletearea.php?no=" . $row[0] . "'>Delete</a></td>
						</tr>
				";
			}
			echo "</table>";
