    ...
    <form method="post">
        ...
        <div style="margin-left:15%; padding:1px 16px;">
            ...
            if (isset($_POST["submit"])) {
				...
				$row = mysqli_fetch_array($start);
				if ($row[2] == 0) {
					$result = mysqli_query($system, "DELETE from area where id=" . $_GET["no"]);
                if ($result) {
					...
					echo "<script>
							alert('Voting Started You Cannot Delete Area');
						</script>";
				}
                
            }
            ?>
            Are you sure to delete the Area with Name:<b><u><?php echo $area; ?></u></b>?<br><br>
