...
<body>
	<form method="post">
		...
		<div style="margin-left:15%; padding:1px 16px;">
			<h2 align="center">LIST OF VOTER</h2>
			<?php
			$qury = mysqli_query($system, "SELECT * from voter");
			...
			while ($row = mysqli_fetch_array($qury)) {
				echo "
					<tr align='center'>
						...
						<td>" . $row[3] . "</td>
						<td>" . $row[4] . "</td>
						<td class='edit'><a href='editvoter.php?no=" . $row[0] . "'>Edit</a></td>
						<td class='delet'><a href='deletevoter.php?no=" . $row[0] . "'>Delete</a></td>
						</tr>
				";
			}
			echo "</table>";
